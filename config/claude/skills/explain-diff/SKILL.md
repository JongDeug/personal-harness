---
name: explain-diff
description: Use when the user asks for a rich explanation of a code change, diff, branch, or PR. Produces a self-contained, interactive HTML page (Background / Intuition / Code / Quiz). 트리거는 `/explain-diff`, "이 변경 설명해줘", "diff/PR 설명해줘".
---
...
Source: https://gist.github.com/geoffreylitt/a29df1b5f9865506e8952488eac3d524 (by Geoffrey Litt).
The gist also has a Notion-output variant (`explain-diff-notion`) which requires a Notion MCP server; add it if/when Notion MCP is configured.
